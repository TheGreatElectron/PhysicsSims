...
Spring.prototype.display = function() {
  ...
  var amp = this.oscAmp * exp((-1*mu*this.time)/(2*this.m));
  ...
  this.displacement.x = this.equilibrium.x + (amp * sin(theta));
  this.velocity.x = amp * sin(theta + PI/2);
  this.acceleration.x = - amp * sin(theta);
